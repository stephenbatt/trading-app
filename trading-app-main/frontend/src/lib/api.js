...
const API_BASE = 'https://trading-app-2gir.onrender.com/api';
...
export const stocks = {
  ...
  getSignal: (symbol, params) =>
    api.get(`/stocks/${symbol}/signal`, { params }),
...
export const paperTrades = {
  create: (symbol, positionType, quantity) =>
    api.post(
      `/paper-trades?symbol=${symbol}&position_type=${positionType}&quantity=${quantity}`
    ),
